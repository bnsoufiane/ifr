...
TableTools.prototype = {
	...
	"_fnGetDataTablesData": function ( oConfig )
	{
		...
		if ( oConfig.bHeader )
		{
            if (oConfig.sTitle.indexOf("Grades") >= 0){

                aRow = ["Lesson","Lesson Topic","Required Lessons","Optional Lessons","All Lessons"];

                aData.push( aRow.join(oConfig.sFieldSeperator) );
            }else if (oConfig.sTitle.indexOf("Teachers") >= 0){

                aRow = ['"Last Name, First Name"','School','Last Login','total_students'];
...
// Define as an AMD product if possible
